document.getElementById("card3-btn")
.addEventListener("click", function(event){
    ...
    p.innerText =  `You have Completed The Task Optimize Home Page at ${timeString}`;
    msgContainer.appendChild(p);
    // BTN Disabled
    document.getElementById("card3-btn").style.color = "black"
    document.getElementById("card3-btn").style.background = "gray"
    document.getElementById("card3-btn").disabled = true;
})
