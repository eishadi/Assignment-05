document.getElementById("card4-btn")
.addEventListener("click", function(event){
    ...
    p.innerText =  `You have Completed The Task Add New Emoji 🤲 at ${timeString}`;
    msgContainer.appendChild(p);
    // BTN Disabled
    document.getElementById("card4-btn").style.color = "black"
    document.getElementById("card4-btn").style.background = "gray"
    document.getElementById("card4-btn").disabled = true;
})
