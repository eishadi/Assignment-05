document.getElementById("card2-btn")
.addEventListener("click", function(event){
    ...
    p.innerText =  `You have Completed The Task Add Dark Mode at ${timeString}`;
    msgContainer.appendChild(p);
    // BTN Disabled
    document.getElementById("card2-btn").style.color = "black"
    document.getElementById("card2-btn").style.background = "gray"
    document.getElementById("ccard2-btn").disabled = true;
})
