...
.addEventListener("click", function(event){
    ...
    p.innerText =  `You have Completed The Task Improve Job Searching at ${timeString}`;
    msgContainer.appendChild(p);
    // BTN Disable
    document.getElementById("card6-btn").style.color = "black"
    document.getElementById("card6-btn").style.background = "gray"
    document.getElementById("card6-btn").disabled = true;
})
