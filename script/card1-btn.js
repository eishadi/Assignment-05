document.getElementById("card1-btn")
.addEventListener("click", function(event){
    ...
    p.innerText =  `You have Completed The Task Fix Mobile Issue at ${timeString}`;
    msgContainer.appendChild(p);
    // BTN Disabled
    document.getElementById("card1-btn").style.color = "black"
    document.getElementById("card1-btn").style.background = "gray"
    document.getElementById("card1-btn").disabled = true;
})
